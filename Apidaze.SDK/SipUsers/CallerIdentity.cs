...
namespace Apidaze.SDK.SipUsers
{
    ...
    public class CallerIdentity
    {
        ...
        [JsonProperty("outboundCallerIdName")]
        ...
        [JsonProperty("outboundCallerIdNumber")]
        ...
        [JsonProperty("internalCallerIdName")]
        public string InternalCallerIdName { get; set; }

        /// <summary>
        ///     Gets or sets the internal caller identifier number.
        /// </summary>
        /// <value>The internal caller identifier number.</value>
        [JsonProperty("internalCallerIdNumber")]
        public string InternalCallerIdNumber { get; set; }
    }
}