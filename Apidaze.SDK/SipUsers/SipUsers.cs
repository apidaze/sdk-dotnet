...
namespace Apidaze.SDK.SipUsers
{
    ...
    public class SipUsers : BaseApiClient, ISipUsers
    {
        ...
        public SipUser CreateSipUser(string userName, string name = "", string emailAddress = "",
            string internalCallerIdNumber = "", string externalCallerIdNumber = "")
        {
            if (string.IsNullOrEmpty(userName)) throw new ArgumentException("userName must not be null or empty");
        ...
        {
            if (string.IsNullOrEmpty(id)) throw new ArgumentException("id must not be null");
        ...
        {
            if (string.IsNullOrEmpty(id)) throw new ArgumentException("id must not be null or empty");
